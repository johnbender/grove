...
run_fun() -> mnesia:transaction(fun() ->qlc:e(qlc:sort(qlc:q(
[{ shop ,  Shop#shop.item, Shop#shop.cost} || Shop <- mnesia:table(shop)  
    , Shop#shop.item =/= apple, Shop#shop.cost =/= 2.3]), {order, descending})) end).
